...
export const photos = [
  ...
  { name: 'young-1',      ratio: 0.750, caption: 'Evidence of cuteness',     alt: 'Fatima as a young girl' },
  { name: 'aunt',         ratio: 0.563, caption: 'Auntie duty',              alt: 'Fatima with her aunt' },
  { name: 'zeya-1',       ratio: 0.750, caption: 'Zeya, part one',           alt: 'Zeya and Fatima together' },
  { name: 'zeya-2',       ratio: 1.333, caption: 'Zeya, the sequel',         alt: 'Zeya and Fatima, another day' },
  { name: 'zeya-mirror',  ratio: 0.563, caption: 'Mirror check, passed',     alt: 'Zeya and Fatima in the mirror' },
  { name: 'asuma-hadi',   ratio: 0.750, caption: 'Gown committee',           alt: 'Fatima, Asuma and Hadi in gowns' },
  { name: 'zeya-asuma',   ratio: 1.333, caption: 'Sky supervision',          alt: 'Zeya, Fatima and Asuma under a blue sky' },
  { name: 'swaray-1',     ratio: 1.332, caption: 'Beach meeting, adjourned', alt: 'Swaray and Fatima at the beach' },
  { name: 'swaray-goofy', ratio: 0.750, caption: 'Sibling behaviour',        alt: 'Swaray and Fatima being goofy' },
  { name: 'swaray-serious', ratio: 0.750, caption: 'Attempting serious',     alt: 'Swaray and Fatima with straight faces' },
  { name: 'swaray-2',     ratio: 0.750, caption: 'Take two',                 alt: 'Swaray and Fatima again' },
  { name: 'swaray-amp',   ratio: 0.562, caption: 'The dynamic duo',          alt: 'Swaray and Fatima side by side' },
  { name: 'sis-swaray',   ratio: 1.333, caption: 'House representatives',    alt: 'Fatima, her sister and Swaray' },
  { name: 'goofy-group',  ratio: 0.750, caption: 'Thumbs up for chaos',      alt: 'The group giving thumbs up' },
  { name: 'group2',       ratio: 1.333, caption: 'Street parliament',        alt: 'The crew posing outside' },
  { name: 'group-collage',ratio: 0.563, caption: 'Red carpet, both takes',   alt: 'Collage from the red carpet event' },
  { name: 'taifou',       ratio: 1.500, caption: 'Taifou made the cut',      alt: 'Taifou and Fatima' },
];
...
export const wishes: Wish[] = [
  ...
  { from: 'TJay',   photo: 'tjay',        ratio: 0.750, alt: 'Swaray, Fatima and TJay', kind: 'text',
    text: "I’m probably not the best at expressing these things, but I genuinely care about you. I appreciate your presence and all the little moments that have made knowing you special. On your birthday, I just hope life gives you the same kindness and happiness you give to the people around you. And if I could give you one thing on your birthday, it would be the ability to see yourself through the eyes of the people who genuinely care about you. Maybe then you'd understand just how special you are.\n\nI don't even think you realize how much joy your presence brings. One minute you're being the kindest person in the room, making everyone feel comfortable and cared for. The next minute you're causing trouble and making people wonder if peace was ever an option. Somehow, you've mastered both.\n\nSo as another chapter begins, I pray life is gentle with you. I pray you find happiness that stays, people who value your heart, and dreams that slowly become reality.\n\nHappy blessed birthday Snow White" },
